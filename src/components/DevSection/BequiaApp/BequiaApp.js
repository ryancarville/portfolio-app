      ...
      <section className="section-wrapper" id="project-1">
        <article className="project-wrapper">
          {this.state.demo_size === "desktop" ? (
            <div id="screenshot-bequia-desktop" className={this.state.fadeIn} />
          ) : (
          ...
          <div className="project-info">
            ...
            <span className="git-hub-wrapper">
              ...
              <span className="git-hub-links">
                <a
                  href="https://github.com/ryancarville/bequia-forum-app"
                  target="_blank"
                ...
                <a
                  href="https://github.com/ryancarville/bequia-forum-api"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  API Repo
